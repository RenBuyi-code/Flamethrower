...
void wk_adc1_init(void)
{
  ...
  gpio_init_struct.gpio_pins = ADC_PRESSURE_PIN;
  gpio_init(ADC_PRESSURE_GPIO_PORT, &gpio_init_struct);

  /* configure the IN4 pin */
  gpio_init_struct.gpio_mode = GPIO_MODE_ANALOG;
  gpio_init_struct.gpio_pins = ADC_PW1_PIN;
  gpio_init(ADC_PW1_GPIO_PORT, &gpio_init_struct);

  /* configure the IN5 pin */
  gpio_init_struct.gpio_mode = GPIO_MODE_ANALOG;
  gpio_init_struct.gpio_pins = ADC_PW2_PIN;
  gpio_init(ADC_PW2_GPIO_PORT, &gpio_init_struct);

  /* configure the IN6 pin */
  gpio_init_struct.gpio_mode = GPIO_MODE_ANALOG;
  gpio_init_struct.gpio_pins = ADC_PW3_PIN;
  gpio_init(ADC_PW3_GPIO_PORT, &gpio_init_struct);
