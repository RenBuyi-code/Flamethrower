...
/* task handler */
extern TaskHandle_t safety_handle;
extern TaskHandle_t control_handle;
extern TaskHandle_t actuator_handle;
extern TaskHandle_t dmx_handle;
extern TaskHandle_t ui_handle;
extern TaskHandle_t diag_handle;
